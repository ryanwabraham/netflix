...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
		...
		handleFilter: function handleFilter(e, filter) {
		...
		getResults: function getResults(requestUrl) {
			var _this = this;
		...
		render: function render() {
			...
			function displayResults() {
				if (!isLoading) {
					if (data.length > 0) {
						return React.createElement(Results, { resultData: data });
					} else {
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					"div",
					{ id: "account" },
					React.createElement("span", { className: "notifications" }),
	...
	var Hero = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'section',
				{ id: 'hero' },
				React.createElement('img', { className: 'hero__img', srcSet: 'img/x-files-hero.jpg 1x, img/x-files-hero@2x.jpg 2x' }),
				React.createElement(
					'div',
					...
					React.createElement(
						...
						React.createElement('img', { className: 'hero__logo', src: 'img/x-files-logo.png', alt: 'The X Files' }),
						React.createElement(
							'a',
			...
			if (this.props.resultData) {
				results = this.props.resultData.map(function (result) {
					if (result.media_type == 'person') {
						...
						return React.createElement(ResultItem, { key: key, title: title, genres: genres, rating: rating, poster: poster });
					}
				});
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Filters = React.createClass({
			...
			handleCertification: function handleCertification(e) {
